...
<body>
  <div class="bg-image p-4"
    style="background-image: url('../assets/images/fondo3.jpg'); background-size: cover; background-position: center; background-repeat:no-repeat; position:relative; z-index:2; overflow:hidden;">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="_lk_de">
            <div class="form-03-main">
              ...
              <form id="login-form" method="POST" role="form" style="display: block;">
                ...
                <div class="form-group">
                  <input type="text" name="usuario" class="form-control _ge_de_ol" placeholder="Ingresa el usuario"
